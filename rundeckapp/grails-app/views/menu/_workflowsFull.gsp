            ...
            <g:hiddenField name="project" value="${params.project}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type='text' name="tagFilter" value="${params.tagFilter}"  id="${enc(attr:rkey)}tagFilter" class="form-control"/>
                ...
                <script>
                    var convertToTagField = function (inputFieldSelector/* :string*/) {

                        jQuery(inputFieldSelector).each(function () {
                            ...
                            elem.before('<ul class="tags-list input-group-addon list-unstyled" style="border-right: 0px;"></ul>');

                            var currentTags = parseTextIntoTags(elem.val());
                            var targetTagListElement = elem.siblings("ul")[0];
                            updateTags();
                            ...
                            //TODO: add a listener on keyup and onblur
                            ...
                            jQuery(this).keyup(function () {
                                ...
                                //TODO: a space or a comma will convert the current text into a tag
                    ...
                    convertToTagField("[name='tagFilter']");
                </script>
